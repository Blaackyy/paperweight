...
open class PaperExtension(objects: ObjectFactory, layout: ProjectLayout) {
    ...
    val sourcePatchDir: DirectoryProperty = objects.dirFrom(baseTargetDir, "patches/sources")
    val resourcePatchDir: DirectoryProperty = objects.dirFrom(baseTargetDir, "patches/resources")
    val featurePatchDir: DirectoryProperty = objects.dirFrom(baseTargetDir, "patches/feature")
